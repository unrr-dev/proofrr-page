...
export const TESTIMONIALS_DATA = [
  ...
  },
  {
    id: 2,
    rating: 5,
    quotePrefix: "Proofrr solves the one problem marketing and design teams dread the most - creative reviews. It's really helped us in communicating feedback effectively, keeping track of feedback and changes across iterations, and organizing it all under one roof. ",
    highlightText: "Extremely useful and very easy to use as well.",
    quoteSuffix: "",
    author: "Nikhil",
    role: "Marketing Director, Wiom",
    avatar: "https://res.cloudinary.com/djxnyqaya/image/upload/v1789462851/Mask_group_3_bkdkdu.png",
  },
  {
    id: 3,
    rating: 5,
